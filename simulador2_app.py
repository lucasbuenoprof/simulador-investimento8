...
if st.button("Calcular"):
    ...
    for mes in range(1, meses+1):
        ...
        resultado.append([mes, round(juros_mes,2), round(acumulado,2), round(juros_acumulados,2)])

    df = pd.DataFrame(resultado, columns=["Mês","Juros","Acumulado","Juros Acumulado"])
